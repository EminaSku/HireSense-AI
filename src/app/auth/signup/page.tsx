  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        toast.success("Welcome to HireSense AI!")
      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="font-bold text-2xl">HireSense AI</span>
          </Link>
        ...
        <Card className="glass-card">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>
              Get started with 10 free evaluations
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>10 free evaluations included</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500" />
              ...
              <Button
                type="submit"
                className="w-full gradient-primary text-white btn-premium"
                disabled={isLoading}
              >
